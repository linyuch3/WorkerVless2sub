...
// 设置优选地址api接口
let addressesapi = [
	'https://addressesapi.lks1220.workers.dev/','https://raw.githubusercontent.com/cmliu/WorkerVless2sub/main/addressesapi.txt','https://addressesapi2.lks1220.workers.dev/' //可参考内容格式 自行搭建。
];
