...
// 设置优选地址api接口
let addressesapi = [
	'https://addressesapi.lks1220.workers.dev/','https://raw.githubusercontent.com/linyuch3/WorkerVless2sub/main/addressesapi.txt','https://addressesapi.090227.xyz/CloudFlareYes','https://addressesapi.090227.xyz/ct','https://addressesapi.090227.xyz/cmcc' //可参考内容格式 自行搭建。
];
...
export default {
	async fetch (request, env) {
		...
		if (userAgent.includes('telegram') || userAgent.includes('twitter') || userAgent.includes('mi')) {
